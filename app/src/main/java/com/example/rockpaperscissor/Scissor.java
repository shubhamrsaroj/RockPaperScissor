...
public class Scissor extends AppCompatActivity {
    public int randomNumber;
      ImageButton papersu,scissorsu,rocku;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scissor);
          papersu=findViewById(R.id.imageButton11);
          scissorsu=findViewById(R.id.imageButton12);
          rocku=findViewById(R.id.imageButton13);
        rando();
        papersu.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        scissorsu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Rockk();
        ...
        rocku.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Rockk();
